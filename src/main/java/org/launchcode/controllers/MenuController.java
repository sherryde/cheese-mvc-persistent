...
public class MenuController {
    ...
    //  handler to display the main menus form
    ...
    public String viewOneMenu(Model model, @PathVariable int menuId) {
    ...
    // handler to process the add item to menu form
    ...
    public String processAddItem(Model model, @ModelAttribute @Valid AddMenuItemForm form, Errors errors) {
        ...
        menu.addItem(cheese); // added to the menu
